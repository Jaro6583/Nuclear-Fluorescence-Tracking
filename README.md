...
## TODO
- Fix thresholding function
    - Find fix for the disappearing regions
    - Be gentler with the min and max region sizes (explore each z-slice)
    - Improve the crescent-closer (allow for thin envelope regions but still find a way to close the gap)
